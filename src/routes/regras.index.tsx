...
export const Route = createFileRoute("/regras/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Entenda como funciona o ranking, os desafios aos domingos e a pontuação.",
      },
    ],
  }),
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-8">
        ...
        >
          <Card className="p-5 space-y-3 shadow-card">
            <p className="text-sm">Cada dupla ou quarteto informa, a cada mês:</p>
            <ul className="text-sm space-y-1 list-disc list-inside text-muted-foreground">
              <li>
                Quais <strong>domingos do mês</strong> está disponível.
              </li>
              <li>
                O <strong>horário</strong> disponível em cada domingo.
              </li>
              <li>
                A <strong>arena preferida</strong>.
              </li>
            </ul>
            <p className="text-xs text-muted-foreground">
              A disponibilidade é renovada automaticamente a cada novo mês. Apenas o capitão da
              equipe edita.
            </p>
          </Card>
        </Section>
        ...
        <Section icon={<Swords className="size-4 text-white" />} title="Como funciona o desafio">
          <Card className="p-5 space-y-3 shadow-card">
            <ol className="text-sm space-y-2 list-decimal list-inside">
              <li>
                Ao desafiar uma equipe, o sistema busca{" "}
                <strong>automaticamente um domingo em comum</strong>.
              </li>
              <li>
                Os <strong>horários coincidentes</strong> são exibidos.
              </li>
              <li>O desafiante escolhe um dos horários disponíveis.</li>
              <li>O desafio já é criado com data e horário definidos.</li>
              <li>
                O adversário pode: <Badge variant="default">Aceitar</Badge>{" "}
                <Badge variant="outline">Reagendar</Badge>{" "}
                <Badge variant="destructive">Recusar</Badge>
              </li>
              <li>
                Após aceitação, o horário fica bloqueado e o desafio passa para{" "}
        ...
        >
          <Card className="p-5 space-y-3 shadow-card">
            ...
            <p className="text-xs text-muted-foreground border-t pt-3">
              Cada dupla/quarteto deve realizar pelo menos <strong>1 desafio por mês</strong>. As
              penalidades são aplicadas automaticamente pelo sistema.
            </p>
          </Card>
        </Section>

        {/* Ranking individual */}
        <Section icon={<Users className="size-4 text-white" />} title="Ranking Individual">
          <Card className="p-5 space-y-2 shadow-card">
            <p className="text-sm">
              O Ranking Individual é apenas a{" "}
              <strong>soma dos resultados obtidos em Duplas e Quartetos</strong>.
            </p>
            <p className="text-xs text-muted-foreground">
              As regras de movimentação acima (-20, -30, -50) <strong>não se aplicam</strong> ao
              Ranking Individual.
            </p>
          </Card>
        </Section>
        ...
        {/* Bônus */}
        <Section icon={<Trophy className="size-4 text-white" />} title="Bônus por atividade">
